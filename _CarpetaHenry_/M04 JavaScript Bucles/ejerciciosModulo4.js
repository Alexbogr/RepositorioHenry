...
console.log(obtenerMayor(4, 7));
//7

// O tambien se puede realizar de la siguiente manera --->

function obtenerMayor1 (x, y) {
    return x > y ? x : y
}
console.log(obtenerMayor1(1, 3));
//3
...
console.log(operadoresLogicos((3*2), (2/2), (4/8)));
// "Numer0 1 es mayor y positivo"
...
// O se puede realizar de la siguiente forma --->
...
console.log(tieneTresDigitos(1290));
// false
...
console.log(tieneTresDigitos(117));
// true
